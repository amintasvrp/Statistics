---
title: "Relatório da Atividade 5 - Manhã"
...
#### Código Utilizado e Saída no Console
...
Percebemos que os valores referentes às proporções de intervalos de confiança que contém os valores verdadeiros dos parâmetros p e X são próximos do valor do nível de confiança destes intervalos. Dessa forma, concluímos que quanto maior o nível de confiança, maior será a proporção de intervalos que contém os valores verdadeiros dos parâmetros da população. 